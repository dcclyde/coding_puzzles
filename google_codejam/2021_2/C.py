...
Number can only increase by 1 at a time.
If the number goes up by 1, new entry is smaller than the previous one,
    but there may be different possibilities in that category.
If the

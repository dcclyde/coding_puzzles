...
void solve() {
    ...
    ll1(r1, c1, r2, c2);
    dbgR(R, C);
    dbgR(MP(r1,c1), MP(r2,c2));
    el;

    // If at least one of the points is in a corner, the answer is 2.
    if (
        (r1 == 0 && c1 == 0)
        || (r1 == R-1 && c1 == 0)
        || (r1 == 0 && c1 == C-1)
    ...
    // if at least one of the points is on an edge, the answer is 3.
    if (r1 == 0 || r1 == R-1 || c1 == 0 || c1 == C-1 ||
        r2 == 0 || r2 == R-1 || c2 == 0 || c2 == C-1) {
        return ps(3);
    }

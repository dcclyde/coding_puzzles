...
void solve() {
    ...
    FOR(k, 1, N-1) {
        ...
        /*
            ...
            The first p-2 trials will kill most of the danger. That's 0..p-3.
            Then I need PEOPLE-1 - chunk_size > p-3.
            p < PEOPLE - chunk_size + 2
        */

        dbg(k, chunk_size);

        // position k-chunk_size should not be included in the first (num_scary).
        // in other words, I need k - chunk_size >= num_scary.
        // num_scary <= k - chunk_size

        // there are k+1 people total.
        // if I'm 3 then num_scary would be 2 (wolog looking down)
        // if I need num_scary <= 0 then I'd get output of 1.
        ll curr = k - chunk_size + 2;
        out.push_back(curr);
    }

...
ll d(ll r1, ll c1, ll r2, ll c2) {
    return d(r1-r2, c1-c2);
}
...
void solve() {
    ...
    V<pll> v1 = {{1,1},{R,C}};
    V<pll> v2 = {{1,C},{R,1}};
    ll d1 = d(sr, sc, v1[0].first, v1[0].second) + d(sr, sc, v1[1].first, v1[1].second);
    ll d2 = d(sr, sc, v2[0].first, v2[0].second) + d(sr, sc, v2[1].first, v2[1].second);

    if (d1 >= d2) {
        ps(v1[0].first, v1[0].second, v1[1].first, v1[1].second);
    } else {
        ps(v2[0].first, v2[0].second, v2[1].first, v2[1].second);
    }

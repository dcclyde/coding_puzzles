...
void solve() {
    ...
    // I want the diagonal with as many 1s as possible.
    int best_diag = 0;
    FOR(start, 0, N) {
        int curr = 0;
        FOR(r, 0, N) {
        ...
        ckmax(best_diag, curr);
    }
    int cost_0to1 = N - best_diag;
    int cost_1to0 = num_ones - best_diag;
    int out = cost_0to1 + cost_1to0;
    ps(out);

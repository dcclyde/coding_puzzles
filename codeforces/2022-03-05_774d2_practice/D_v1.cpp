...
void solve() {
	...
	// ll best_total = 1e18;
	// int best_num_nodes = 2e9;
	// vector<int> best_costs;

	// for ( int favorite_color = 0 ; favorite_color < 2 ; ++favorite_color ) {
	// 	// only consider color(s) that comprise at least half of the tree.
	// 	if ( count_per_color[favorite_color] < count_per_color[1-favorite_color] ) {
	// 		continue;
	// 	}
	// 	ll curr_total = 0;
	// 	vector<int> curr_costs( N );
	// 	FOR( k , 0 , N ) {
	// 		if ( color[k] == favorite_color ) {
	// 			curr_costs[k] = G[k].size();
	// 		} else {
	// 			curr_costs[k] = 1;
	// 		}
	// 		curr_total += curr_costs[k];
	// 	}
	// 	if ( curr_total < best_total ) {
	// 		best_costs = curr_costs;
	// 		best_total = curr_total;
	// 		best_num_nodes = count_per_color[favorite_color];
	// 	}
	// }

	// cout << best_num_nodes << ' ' << best_total << '\n';
	// for ( int k = 0 ; k < N ; ++k ) {
	// 	cout << best_costs[k] << ' ';
	// }
	// cout << '\n';

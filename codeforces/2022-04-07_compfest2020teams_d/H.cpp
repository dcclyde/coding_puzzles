...
void solve() {
    ...
    bool small_possible = (b+c > 0);
    bool big_possible = (a+d > 0);
    bool product_negative = ((a+b) % 2 == 1);

    V<bool> out;
    out.push_back(product_negative && big_possible);
    out.push_back(product_negative && small_possible);
    out.push_back((!product_negative) && small_possible);
    out.push_back((!product_negative) && big_possible);

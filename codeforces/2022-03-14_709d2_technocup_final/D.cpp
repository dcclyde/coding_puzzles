...
tcT> struct SegTree { // cmb(ID,b) = b
	...
	void upd(int p, int val_) { // set val at position p
        T val = MP(val_, val_);
...
void solve() {
    ...
    while ( true ) {
        /*
            ...
            That means finding first 1 in [pos:] + [0:pos].
        */
        ...
        // now I need to increment pos, then update that gcd, then increment pos AGAIN.
